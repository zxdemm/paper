public class StudentEnrollment {
    ...
    {
	int maxTuitionBalance=maxSemesterCredits * costPerCredit + totalCredits * ((costPerCredit / 100) * 6); // int maxTuitionBalance = maxSemesterCredits * costPerCredit + maxSemesterCredits * ((costPerCredit/100)*6);
	if (maxTuitionBalance < tuitionBalance || passedCredits > totalCredits) { // if (maxTuitionBalance < tuitionBalance) {
    ...
    public void enrollmentProcess(int passedCredits, int semesterCredits, int payment, int initialBalance, boolean lateRegistration, boolean debit, boolean option) 
     {
        ...
        this.passedCredits=passedCredits; // setPassedCredits(passedCredits);
