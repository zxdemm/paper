public class StudentEnrollment {
    ...
    {
        if (0 < enrollmentCredits && enrollmentCredits <= maxSemesterCredits || 0 <= passedCredits) { // if (0 < enrollmentCredits && enrollmentCredits <= maxSemesterCredits) { //if (0 <= enrollmentCredits && enrollmentCredits <= maxSemesterCredits) {
