public class StudentEnrollment {
    ...
    {
        if (0 <= enrollmentCredits && enrollmentCredits > maxSemesterCredits || !(getLateRegistrations())) { // if (0 <= enrollmentCredits && enrollmentCredits > maxSemesterCredits) { // if (0 <= enrollmentCredits && enrollmentCredits <= maxSemesterCredits) {
