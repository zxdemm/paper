public class Time {
    ...
    public /*@ pure @*/ boolean later_than(Time start) 
    {
        if (this.hour != start.hour) {
            ...
            return this.minute != start.minute; // return this.minute <= start.minute; //return this.minute > start.minute;
        } else { 
    ...
    {	if (!(stop != null && start != null)) throw new java.lang.IllegalArgumentException();
