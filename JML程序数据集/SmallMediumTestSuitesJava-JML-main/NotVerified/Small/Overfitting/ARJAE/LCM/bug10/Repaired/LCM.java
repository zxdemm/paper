public class LCM {
	...
	if (div(result,num1) == 0 && div(result,num2) != 0 || div(result,num1) == 0 && div(result,num2) == 0) { //if (div(result, num1) == 0 && div(result, num2) != 0) { // if (div(result, num1) == 0 && div(result, num2) == 0) {;
		return result;
	}
	return -1;
    }
