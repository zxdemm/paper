public class StudentEnrollment {
    ...
    {
        if (0 > enrollmentCredits && enrollmentCredits <= maxSemesterCredits || !(lateRegistration)) { // if (0 > enrollmentCredits && enrollmentCredits <= maxSemesterCredits) { // if (0 <= enrollmentCredits && enrollmentCredits <= maxSemesterCredits) {
