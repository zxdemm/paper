public class StudentEnrollment {
	...
	if (maxTuitionBalance < tuitionBalance && !(getLateRegistrations())) { // if (maxTuitionBalance < tuitionBalance) {
    ...
    {
        return (this.tuitionBalance <= 0); // return (this.tuitionBalance < 0); // return (this.tuitionBalance <= 0);
    }
