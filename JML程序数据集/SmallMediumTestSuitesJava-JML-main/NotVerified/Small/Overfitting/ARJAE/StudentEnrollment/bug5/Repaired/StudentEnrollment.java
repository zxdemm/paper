public class StudentEnrollment {
	...
	if (maxTuitionBalance < tuitionBalance || !(0 <= enrollmentCredits && enrollmentCredits <= maxSemesterCredits)) { // if (maxTuitionBalance < tuitionBalance) {
    ...
    {
        if (0 > passedCredits && passedCredits <= totalCredits || !(0 > passedCredits && passedCredits <= totalCredits)) { // if (0 > passedCredits && passedCredits <= totalCredits) { //if (0 <= passedCredits && passedCredits <= totalCredits) {
